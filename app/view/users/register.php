...
<div class="row">
    <div class="col-md-6 mx-auto">
        <div class="card card-body bd-light mt-5">
            ...
            <p>Please fill out tyhis form to register with us</p>
            <form action="<?php echo URL_ROOT?>/users/register" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="confirm_password" value="<?php echo $data['name'] ?>" class="form-control form-control-lg <?php echo (!empty($data['confirm_password_error'])) ?  "is-invalid" : "" ?> ">
                    <span class="invalid-feedback">
